...
import SafeModeConfigModal, { DisplayConfig, DEFAULT_CONFIG } from './SafeModeConfigModal';
...
const Footer: React.FC<FooterProps> = ({ simplified = false }) => {
  ...
  const handlePinVerified = () => {
    // PIN verified, open config modal
    setShowConfigModal(true);
  };

  const handleSaveConfig = async (config: DisplayConfig, newSafeMode: boolean): Promise<boolean> => {
    return await safeMode.saveConfig(config, newSafeMode);
  };

  // Copyright text component with hidden trigger
  const CopyrightText = () => (
    <span
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex items-center space-x-3 mb-4 md:mb-0">
                <img src={LOGO_URL} alt="SnapfaceID" className="h-8 w-8 rounded-lg" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-xl font-bold">SnapfaceID</span>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed">
                Your personal safety companion for dating. Verify identities, share reports, and stay protected while meeting new people.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/cancel-subscription" className="text-gray-400 hover:text-white transition-colors">
                    Cancel Subscription
                  </Link>
                </li>
                <li>
                  <a href="mailto:support@snapfaceid.com" className="text-gray-400 hover:text-white transition-colors">
