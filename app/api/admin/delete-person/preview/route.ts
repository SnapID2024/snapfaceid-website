...
// POST /api/admin/delete-person/preview - Preview what will be deleted
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/admin/delete-person/preview`, {
      method: 'POST',
      headers: {
    ...
    console.error('Error in delete-person preview:', error);
