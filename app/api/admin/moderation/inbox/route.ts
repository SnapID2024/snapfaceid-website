...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    let url = `${BACKEND_API_URL}/api/admin/moderation/inbox`;
    ...
    if (!response.ok) {
      return NextResponse.json(
        { error: data.detail || 'Failed to fetch moderation inbox' },
    ...
    console.error('Error fetching moderation inbox:', error);
